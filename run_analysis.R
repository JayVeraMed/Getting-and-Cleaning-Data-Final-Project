...
#Step 1: Merges the training and the tests sets to create one single data set
...
#Step 6: Check variable names in FinalData object
FinalData
summary(FinalData)
str(FinalData)
#180 rows (obs) and 88 cols (var)
